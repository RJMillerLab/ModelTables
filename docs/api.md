...
| --------------------------------- | -------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------- | ---------------------------------------------- |
| `download(resource, mode)`        | `modelcard` / `github` / `arxiv` <br> `scratch`/`update` | - `python -m src.data_preprocess.step1_parse`<br>- `python -m src.data_preprocess.step1_down_giturl`<br>- `python -m src.data_preprocess.step2_arxiv_get_html`                                   | Local cache and folders                 | Downloads modelcard/github/arxiv artifacts     |
| `extract_table(resource, mode)`   | Same as above                                            | - `python -m src.data_preprocess.step2_hugging_github_extract`<br>- `python -m src.data_preprocess.step2_arxiv_parse`                                                                          | Table CSV folders, mapping parquet/json | Extracts/cleans tables to local CSVs           |
| `quality_control(mode)`           | `intra` / `inter`                                        | - `python -m src.data_preprocess.step2_dedup_tables`<br>- `python -m src.data_preprocess.step2_merge_tables`                                                                                                | Cleaned table folders, stats/figures    | Intra: within source; Inter: cross-source      |
| `extract_relatedness(resource)`   | `paper`/`model`/`dataset`/`all`                          | - `python -m src.data_gt.paper_citation_overlap`<br>- `python -m src.data_gt.modelcard_matrix`                                                                                                 | Binary matrix (npz/pkl), CSV lists      | Extracts unionability/relatedness ground truth |
...
| --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `download`            | `src.data_preprocess.step1_parse`, `src.data_preprocess.step1_down_giturl`, `src.data_preprocess.step2_arxiv_get_html`                                         |
| `extract_table`       | `src.data_preprocess.step2_hugging_github_extract`, `src.data_preprocess.step2_arxiv_parse`                                                                  |
| `quality_control`     | `src.data_preprocess.step2_dedup_tables`, `src.data_preprocess.step2_merge_tables`                                                                                        |
| `extract_relatedness` | `src.data_gt.paper_citation_overlap`, `src.data_gt.modelcard_matrix`                                                                                         |
