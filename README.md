...
python src/baseline_1/table_retrieval_pipeline.py \
encode \
    --jsonl data/tmp/corpus/subset.jsonl \
    --model_name sentence-transformers/all-MiniLM-L6-v2 \
    --batch_size 256 \
    --output_npz data/tmp/index_dense_subset/embeddings.npz \
    --device cuda 
...
python src/baseline2/hybrid_rerank.py \
  ...
  --queries-tsv  data/tmp/queries_table.tsv \
  --mapping-json data/tmp/queries_table_mapping.json \
  --dense-npz    data/tmp/index_dense_subset/embeddings.npz \
  --topk 11 --device cuda \
