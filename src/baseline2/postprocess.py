#!/usr/bin/env python3
"""
Deprecated: use src/baseline1/table_retrieval_pipeline.py postprocess instead

# python -m src.baseline2.postprocess \
#  --input data/tmp/search_result_251117.json \
#  --output data/tmp/baseline2_sparse_results_251117.json \
#  --top1-list data/tmp/queries_with_top1_matches_251117.txt # deprecated
...
#   --top1-list data/tmp/hybrid_queries_with_top1_matches.txt # deprecated
...
def main():
    ...
    processed_results = append_csv_suffix(processed_results)
