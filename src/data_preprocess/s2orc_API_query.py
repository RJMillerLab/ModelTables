...
def merge_cit_ref(df_titles, df_citations, df_references, output_file, merge_key):
...
def merge_all_results(titles_cache, citations_cache, references_cache, output_file, merge_key):
    """
    ...
    merge_cit_ref(df_titles, df_citations, df_references, output_file, merge_key)
...
if __name__ == "__main__":
    ...
    merge_all_results(titles_cache=titles_cache_file, citations_cache=citations_cache_file, references_cache=references_cache_file, output_file=merged_results_file, merge_key=MERGE_KEY)
